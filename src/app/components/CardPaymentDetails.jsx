    ...
    <>
      <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
        ...
        <form onSubmit={handleSubmit}>
          <div className="">
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              {/* <input
                type="text"
                name="billing-zip"
                className="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/4"
                value={billingZip}
          ...
          <button
            type="submit"
            className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white disabled:opacity-50 hover:bg-gray-800"
